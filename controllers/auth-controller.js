...
exports.getSigninPage = (req, res) => {
  ...
  exports.signup = (req, res, next) => {
    ...
    if(req.body.password.trim().length < 3 || (req.body.password.trim() !== req.body.confirmPassword.trim()) ){
        return res.render("auth/auth", {
            signup: true,
            layout: "partials/prelogin",
                ...
                db.User.findOne({
                    ...
                    if (dbUser !== null) {
                        return res.render("auth/auth", {
                            signup: true,
                            layout: "partials/prelogin",
                            error: "Email is taken, Please use the password reset link or choose a new email",
                            companyUID: req.body.companyUID,
                            emailAddress: req.body.emailAddress,
                            name: req.body.name,
                            phoneNumber: req.body.phoneNumber
